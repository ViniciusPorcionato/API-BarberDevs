...
Rg VARCHAR(100),
Cpf VARCHAR(100),
CodRecupSenha VARCHAR(100)
);

CREATE TABLE Barbeiro(
IdBarbeiro UNIQUEIDENTIFIER PRIMARY KEY REFERENCES Usuario(IdUsuario),
IdBarbearia UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Barbearia(IdBarbearia),
Descricao TEXT
);

CREATE TABLE Cliente(
IdCliente UNIQUEIDENTIFIER PRIMARY KEY REFERENCES Usuario(IdUsuario),
);
